...
#Let's select the orgin with respect to the radius


length = 361 # We want at most 360 numbers
...
total = 0;
angles = [] #The angles that each number will occupy



#We will generate rgb colour values for the fillcolor function
...
#Let's draw the first length-1 segments in the circle in case we have more than one number entered
